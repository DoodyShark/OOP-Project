[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=10067805&assignment_repo_type=AssignmentRepo)
# Course Project
...
- [x] Provide a screenshot of your code's output. (Placed it in the Report)
...
| Grammar      | 3      | [3] |                         |
| Structure    | 3      | [3] |                         |
| Visual       | 3      | [2] (because I don't include detailed class diagrams just the simplified one) |                         |
| Content      | 3      | [3] |                         |
| References   | 3      | [3] |                         |
| Total        | 33     | [32] |                         |
...
- *Concept #1*: [Passing by reference], *File Name / Line Number(s)*: [Record.h / 85-114]
- *Concept #2*: [Using the vector container class], *File Name / Line Number(s)*: [adminInterface.h / 9-12]
- *Concept #3*: [Using Pointers], *File Name / Line Number(s)*: [Record.h / 21,23]
- *Concept #4*: [Inline functions], *File Name / Line Number(s)*: [Column.h / 48-50]
- *Concept #5*: [Binary search in sorted lists], *File Name / Line Number(s)*: [Column.h / 57-69]
- *Concept #6*: [Fast Exponentiation], *File Name / Line Number(s)*: [SaveItem.h / 46-53]
